...
sudo sh -c "echo 'backup -fstype=nfs4,rw,soft,intr    hal.lh.802ski.com:/mnt/user/backup' >> /etc/auto.nfs"
sudo sh -c "echo 'linux -fstype=nfs4,rw,soft,intr     hal.lh.802ski.com:/mnt/user/linux' >> /etc/auto.nfs"
